...
const ResumePreview: React.FC<ResumePreviewProps> = ({ data, onBack }) => {
  ...
  const handlePrint = () => {
    toast.success('Сейчас откроется диалог печати. Выберите "Сохранить как PDF" и настройте параметры для лучшего результата!', {
      duration: 3000
    });
    setTimeout(() => {
      window.print();
    ...
    <div className="resume-preview">
      <div className="preview-header">
        ...
        <div className="print-instructions">
          ...
          <p>2. В диалоге печати:</p>
          <p>&nbsp;&nbsp;&nbsp;• Выберите "Сохранить как PDF"</p>
          <p>&nbsp;&nbsp;&nbsp;• Убедитесь что выбран размер бумаги A4</p>
          <p>&nbsp;&nbsp;&nbsp;• Уберите галочку "Верхние и нижние колонтитулы"</p>
          <p>3. Нажмите "Сохранить" - получите идеальное резюме!</p>
        </div>
      </div>
